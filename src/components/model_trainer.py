...
class ModelTrainer():
    ...
    def initiate_model_trainer(self,train_array,test_array,preprocessor_path):
        ...
        try:
            ...
            params={    # Hyper parameter tuning with respect to each model
                "Decision Tree": {
            ...
            model_report:dict =evaluate_model(X_train=X_train,y_train=y_train,X_test=X_test,y_test=y_test,models=model,param=params) # Defining function in Util
